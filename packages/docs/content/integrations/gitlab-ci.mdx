---
title: "GitLab CI: Network Config Validation with SAST Integration"
description: "Integrate SentriFlow with GitLab CI/CD pipelines for automated network configuration validation. Publish SAST reports to GitLab Security Dashboard with merge request widgets and compliance scanning."
---
