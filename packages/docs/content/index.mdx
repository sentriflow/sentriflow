---
title: "SentriFlow: Open-Source Network Configuration Validation Framework"
description: "Validate Cisco IOS, Juniper Junos, Palo Alto PAN-OS, and 12+ vendor configurations against 59 security rules. Open-source CLI, VS Code extension, and CI/CD integration for automated network compliance."
---
...
<Cards num={2}>
  <Cards.Card
    arrow
    title='Cisco IOS Hardening Checklist'
    href='/guides/cisco-ios-hardening-checklist'
  >
    Complete 2026 security hardening checklist for Cisco IOS and IOS-XE
  </Cards.Card>
  <Cards.Card
    arrow
    title='Automating Compliance Checks'
    href='/guides/automating-network-compliance'
  >
    Build automated config validation pipelines with CI/CD integration
  </Cards.Card>
</Cards>
